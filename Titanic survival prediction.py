...
DataFrame = DataFrame.drop(drop_elements, axis = 1)
...
#### let's do a correlation between the variables in the dataset after training the data
...
#### we can produce the survival of the passengers based on boarding class
sns.barplot(x='Pclass', y='Survived', hue='Sex', data = DataFrame, palette='coolwarm')


# In[50]:


### let's find the age distribution among the passengers
